//https://github.com/imSanjaySoni/Movie-Rating-app-with-flutter-Bloc-patten
import 'dart:async';

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:he_treinamentos/block/cast_and_crew_bloc/cast_bloc.dart';
import 'package:he_treinamentos/block/movie_bloc/movie_bloc.dart';
...
import 'package:he_treinamentos/block/search_block/search_bloc.dart';
import 'package:he_treinamentos/data/repositoties/movie_repositories.dart';
import 'package:he_treinamentos/screens/home.dart';
import 'package:he_treinamentos/screens/network.dart';
import 'package:he_treinamentos/screens/search.dart';
import 'package:shimmer/shimmer.dart';
import 'package:he_treinamentos/core/app_images.dart';
  ...
  Widget tabBar() {
    return SingleChildScrollView(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          tab(0, "BPM", "now_playing"),
          tab(1, "DATASUL", "upcoming"),
          tab(2, "GARANTIA QUALIDADE", "popular"),
          tab(3, "Qlik", "popular"),
          tab(4, "GP MOBILE", "popular"),
        ],
      ),
    );
  }
